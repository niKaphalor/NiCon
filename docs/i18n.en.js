...
window.NICON_I18N_STRINGS.en = {
  ...
  admin: {
    ...
    auditLogHint: "Admin actions and security-relevant account activity across every account on this instance.",
  ...
  console: {
    ...
    clear: "Clear",
    history: "History",
    historyAriaLabel: "Command history",
    historyEmpty: "No commands sent yet.",
  ...
  templates: {
    button: "Templates",
    panelAriaLabel: "Command templates",
    ...
    send: "Send",
    delete: "Delete",
    deleteConfirm: "Delete the saved command \"{{name}}\"?",
    nameAndCommandRequired: "name and command are required",
    loadFailed: "failed to load saved commands",
    saveFailed: "failed to save the command",
    deleteFailed: "failed to delete the command",
  },
  quickCommands: {
    ...
    broadcast: "Broadcast",
    stop: "Stop Server",
    stopConfirm: "This stops the server. Depending on your hosting setup, it may not come back up on its own. Continue?",
    restart: "Restart",
    restartConfirm: "This restarts the server after a short countdown, disconnecting every player. Continue?",
    shutdown: "Shutdown",
    shutdownConfirm: "This shuts the server down. Depending on your hosting setup, it may not come back up on its own. Continue?",
  ...
  addModal: {
    ...
    testFailed: "Could not connect: {{message}}",
    testNeedsHostPort: "Enter a host and port first.",
  ...
  // it was done to (admin actions only), {{detail}} the short context
  // nicon_audit_log() recorded (a server/notification name, a username).
  auditLog: {
    action_loginSuccess: "{{actor}} signed in",
    action_loginFailedKnown: "{{actor}} — failed sign-in attempt",
    action_loginFailedUnknown: "Failed sign-in attempt as \"{{detail}}\"",
    action_passwordChanged: "{{actor}} changed their password",
    ...
    action_adminUserDeleted: "{{actor}} deleted the account \"{{detail}}\"",
  ...
  settings: {
    ...
    activityHint: "Your own account activity, and any admin action that affected your account.",
    activityEmpty: "Nothing logged yet.",
  },
  info: {
