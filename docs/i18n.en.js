...
window.NICON_I18N_STRINGS.en = {
  ...
  health: {
    navLabel: "Health",
    title: "Server health",
    subhead: "Connection status per server: when it last came online, the latency of its most recent player-list check, and its last error, if any. Kept in this browser only — it isn't saved to your account, so it starts empty again in a different browser.",
    colServer: "Server",
    colStatus: "Status",
