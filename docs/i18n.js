  ...
  var dict = {
    en: {
      ...
      admin: {
        ...
        subhead: "Every account on this relay. Regenerating a code or deleting an account takes effect immediately — hand any regenerated code to that person yourself, there's no email to send it to.",
        colCreated: "Created",
        colServers: "Servers",
        colRole: "Role",
        roleAdmin: "Admin",
    ...
    de: {
      ...
      admin: {
        ...
        subhead: "Alle Konten auf diesem Relay. Ein Code neu generieren oder ein Konto löschen wirkt sofort — einen neu generierten Code musst du der Person selbst geben, es gibt keine E-Mail zum Versenden.",
        colCreated: "Erstellt",
        colServers: "Server",
        colRole: "Rolle",
        roleAdmin: "Admin",
