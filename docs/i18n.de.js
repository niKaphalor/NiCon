...
window.NICON_I18N_STRINGS.de = {
  ...
  admin: {
    ...
    auditLogHint: "Admin-Aktionen und sicherheitsrelevante Kontoaktivität über alle Konten dieser Instanz hinweg.",
  ...
  addModal: {
    ...
    testFailed: "Verbindung fehlgeschlagen: {{message}}",
    testNeedsHostPort: "Bitte zuerst Host und Port eingeben.",
  ...
  // wer betroffen war (nur bei Admin-Aktionen), {{detail}} der kurze
  // Kontext, den nicon_audit_log() gespeichert hat.
  auditLog: {
    action_loginSuccess: "{{actor}} hat sich angemeldet",
    action_loginFailedKnown: "{{actor}} — fehlgeschlagener Anmeldeversuch",
    action_loginFailedUnknown: "Fehlgeschlagener Anmeldeversuch als „{{detail}}“",
    action_passwordChanged: "{{actor}} hat das Passwort geändert",
    ...
    action_adminUserDeleted: "{{actor}} hat das Konto „{{detail}}“ gelöscht",
  ...
  settings: {
    ...
    activityKicker: "Aktivität",
    activityHint: "Deine eigene Kontoaktivität sowie jede Admin-Aktion, die dein Konto betroffen hat.",
    activityEmpty: "Noch nichts protokolliert.",
  },
  info: {
